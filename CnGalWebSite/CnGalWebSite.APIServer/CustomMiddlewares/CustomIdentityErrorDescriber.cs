...
namespace CnGalWebSite.APIServer.CustomMiddlewares
{
    public class CustomIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError PasswordRequiresUniqueChars(int uniqueChars) { return new IdentityError { Code = "Password", Description = $"密码至少包括 {uniqueChars} 个不同的字符！" }; }
