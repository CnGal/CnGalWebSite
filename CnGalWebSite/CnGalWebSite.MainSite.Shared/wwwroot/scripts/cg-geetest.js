...
/**
 * 绑定 Geetest 验证到 .NET 对象（无界面 bind 模式）
 * 
 * @param {object} objRef       - DotNetObjectReference
 * @param {string} gt           - Geetest Gt 参数
...
export function initGeetestBindCAPTCHA(objRef, gt, challenge, success) {
    window.initGeetest({
        ...
        captchaObj.onSuccess(function () {
            ...
            objRef.invokeMethodAsync('OnChecked',
